...
// - protoc             v4.25.2
// source: api/proto/bi-direction/bi-direction.proto
...
func (x *chatServiceChatClient) Send(m *base.HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatServiceChatClient) Recv() (*base.HelloResponse, error) {
...
func (x *chatServiceChatServer) Send(m *base.HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatServiceChatServer) Recv() (*base.HelloRequest, error) {
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/bi-direction/bi-direction.proto",
}
